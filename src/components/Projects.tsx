    ...
    <div className="projects">
      ...
      <div className='projects__container'>
        <div className='projects__item'>
          <h2 className='projects__item-title primary'><a className="link" href='https://github.com/mikkel250/portfolio-react-ts'>React Portfolio Site</a></h2>
          <p className='projects__item-desc'>
            A portfolio site intended to demonstrate proficiency with React and Typescript. The styling is still a work in progress, and the deployed version can be viewed here: <a className="link" href='https://graceful-cucurucho-be578d.netlify.app'>https://graceful-cucurucho-be578d.netlify.app</a>
          </p>
        </div>
        <div className='projects__item'>
          <h2 className='projects__item-title primary'><a className="primary link" href='https://github.com/mikkel250/uswds-jekyll'>Jekyll demo site</a></h2>          
          <p className='projects__item-desc'>
            A demo project built for the Census Bureau, the deployed version can be viewed at: <a className="primary link" href='https://gifted-stonebraker-95e99b.netlify.app/'>https://gifted-stonebraker-95e99b.netlify.app/</a>
          </p>
        </div>
        <div className='projects__item'>
        ...
        <div className='projects__item'>
          <h2 className='projects__item-title primary'><a className="link" href='https://github.com/mikkel250/react-ecommerce'>React E-commerce store</a></h2>
          <p className='projects__item-desc'>
        ...
        <div className='projects__item'>
          <h2 className='projects__item-title primary'><a className="link" href='https://github.com/mikkel250/face-recognition'>Face recognition app</a></h2>
          <p className='projects__item-desc'>
